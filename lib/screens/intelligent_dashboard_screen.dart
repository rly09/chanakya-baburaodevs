...
class IntelligentDashboardScreen extends StatefulWidget {
  ...
  @override
  State<IntelligentDashboardScreen> createState() =>
      _IntelligentDashboardScreenState();
}
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color:
                                widget.caseItem.outcome == "Win" ||
                                    widget.caseItem.outcome == "1"
                      ...
                      onTap: () {
                        if (widget.caseItem.courtName != null) {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => CourtAnalyticsScreen(
                                courtName: widget.caseItem.courtName!,
                              ),
                            ),
                          );
                        }
                    ...
                    child: _DashboardActionCard(
                      ...
                      onTap: () {
                        if (widget.caseItem.judgeName != null &&
                            widget.caseItem.judgeName != 'Unknown Judge' &&
                            widget.caseItem.judgeName!.isNotEmpty) {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => JudicialAnalyticsScreen(
                                judgeName: widget.caseItem.judgeName!,
                              ),
                            ),
                          );
                        } else {
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text(
                                'No presiding justice is recorded for this specific precedent.',
                                style: TextStyle(
                  ...
                  Expanded(
                    child: OutlinedButton.icon(
                      onPressed: () => Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              VyoohmScreen(focalCaseId: widget.caseItem.id),
                        ),
                      ),
              ...
              _SectionHeader(
                title: 'STRATEGIC ARGUMENT INTELLIGENCE',
                ...
                builder: (context, snapshot) {
                  ...
                  if (snapshot.hasError || !snapshot.hasData) {
                    return GlassmorphicCard(
                      child: Text(
                        'AI Intelligence offline. Check backend availability.',
                        style: TextStyle(
                          color: AppColors.crimsonLoss.withOpacity(0.7),
                          fontSize: 13,
                        ),
                      ),
                    );
                  ...
                  return Column(
                    children: [
                      _buildTacticStack(
                        'SUGGESTED TACTICS',
                        intel.suggestedArguments,
                        AppColors.legalGold,
                      ),
                      const SizedBox(height: 16),
                      _buildTacticStack(
                        'COMMON WEAKNESSES',
                        intel.commonWeaknesses,
                        AppColors.crimsonLoss,
                      ),
                      const SizedBox(height: 16),
                      _buildTacticStack(
                        'DEFENSE STRATEGIES',
                        intel.commonDefenseStrategies,
                        AppColors.cyanTrend,
                      ),
                    ],
                  );
                  ...
                  children: [
                    ...
                    Text(
                      widget.caseItem.explanation ??
                          "Detailed intelligence analysis pending. AI is processing case facts and legal patterns for higher confidence results.",
                      style: TextStyle(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        _infoTag(
                          'ACTS: ${widget.caseItem.acts.join(", ")}',
                          AppColors.legalGold,
                        ),
